...
import com.paidtocode.stargang.api.response.ObjectResponse;
...
public class AncestorObecjtResponseFactory implements AncestorsFactory {
	@Override
	public Ancestor parse(JSONObject response) throws IOException {
		return new ObjectMapper().readValue(response.toString(), ObjectResponse.class);
	}
